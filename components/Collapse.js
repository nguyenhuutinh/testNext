  ...
  const Collapsed = () => {
    ...
    const [data, setData] = useState([
        ...
        },
        {
            ...
            desc: 'Protein tự nhiên được chiết xuất từ lúa mạch rất dồi dào. Nó có giá trị dinh dưỡng cao và là nguồn cung cấp calo và protein thực vật quan trọng.'
        },
        {
            id: 2,
        ...
        },
        {
            ...
            desc: 'Tình trạng đường huyết sẽ được cải thiện sau 3 tháng sử dụng. Bạn có thể cắt giảm thuốc dần khi đường huyết đã ổn định.'
        },
        {
            id: 4,
            header: "∑  NGUYÊN LIỆU CAO CẤP",
            desc: 'Kiều mạch và lúa mạch cao cấp được trồng ở điều kiện không khí và nguồn nước sạch, không bị ô nhiễm nên rất lành mạnh và an toàn.'
        }
    ...
    return (
        <div className={classes.tab}>
            {data.map((detail) => (
                <div key={detail.id} className={classes.item} onClick={()=>handleExpandClick(detail.id)}>
