	...
	return <div><PageOne/><Container style={{ background: 'white', paddingBottom: '100px' }}>
		<Grid  xl={9}>
			...
			<div className={classes.intro}>
				...
				Việc thu thập dữ liệu chủ yếu trên website <a style={{color:'#084f1f'}} href="https://mikieumach.vn">mikieumach.vn</a> được xác định khi bạn muốn sử dụng dịch vụ
				...
				nhân của mình thông qua website <a style={{color:'#084f1f'}} href="https://mikieumach.vn">mikieumach.vn</a> bằng cách đăng nhập vào tài khoản mà mình đã đăng ký và sửa
